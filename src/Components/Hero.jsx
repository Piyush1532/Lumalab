  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-24 px-4  sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white min-h-[calc(100vh-64px)] '>
      ...
      <motion.div
        ...
        transition={{ opacity: 0.5, delay: 0.7 }}
        viewport={{ once: true }}
      ...
      <motion.p
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ opacity: 0.5, delay: 1 }}
        viewport={{ once: true }}
        className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3 '>Creating meaningfull connections and turning big idea into interactive digital experiences</motion.p>

      <motion.div
        initial={{ opacity: 0, scale: 0.9 }}
        whileInView={{ opacity: 1, scale: 1 }}
        transition={{ opacity: 0.6, delay: 2 }}
        viewport={{ once: true }}
        className='relative'>
